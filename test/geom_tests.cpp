...
//     ASSERT_EQ(PointCart::orientV(p, directly_above), -1);
//     ASSERT_EQ(PointCart::orientV(p, directly_below), 1);
//     ASSERT_EQ(PointCart::orientV(p, p), 0);
// }
...
//     ASSERT_EQ(PointCart::orientE(s, t, just_below), -1);
//     ASSERT_EQ(PointCart::orientE(s, t, just_above), 1);
//     ASSERT_EQ(PointCart::orientE(s, t, on_line), 0);
// }
...
//     ASSERT_EQ(PointCart::orientV(s_1, t_1, s_2, t_2, just_right), 1);
//     ASSERT_EQ(PointCart::orientV(s_1, t_1, s_2, t_2, just_left), -1);
//     ASSERT_EQ(PointCart::orientV(s_1, t_1, s_2, t_2, just_above), -1);
//     ASSERT_EQ(PointCart::orientV(s_1, t_1, s_2, t_2, just_below), 1);
//     ASSERT_EQ(PointCart::orientV(s_1, t_1, s_2, t_2, p), 0);
// }
